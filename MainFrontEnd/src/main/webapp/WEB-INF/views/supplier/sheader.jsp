...
<body>
	<div class="container-fluid" style="background: #232f3e; height: 60px;">
		<div class="row">
			...
			<div class="col-sm-2" style="padding: 30px 6px 0 0px;">
				<div class="dropdown">
					<a href="${context}/sviewproduct" class="astyle" id="dropdownMenu1"
						aria-haspopup="true" aria-expanded="true">
						View All Products </a>
				</div>
			</div>
			<div class="dropdown">
			<div class="col-sm-1" style="padding: 30px 6px 0 0;">
				<a href="${context}/saddproduct" class="astyle" id="dropdownMenu2"
					aria-haspopup="true" aria-expanded="true">
					Add A Product</a>
				</div>
			</div>
			<!--End Of DropDown Container-->
			<div class="col-sm-3" style="padding: 10px 0 0 31%;">
				<p style="color: white">
					<b class="text-capitalize" style="padding-left:8px;">Welcome,</b><b class="text-capitalize" style="padding-left:11px;"> &nbsp;${uname}</b>
				</p>
			</div>
		</div>
	...
	<div class="container-fluid"
		...
		<div class="row">
			...
			<div class="col-sm-3" style="padding: 0 0 0 440px;">
				<div class="dropdown">
					<input type="image"
