...
<body>
	<div class="container-fluid" style="background: #232f3e; height: 60px;">
		<div class="row">
			...
			<div class="col-sm-1" style="padding: 30px 6px 0 0px;">
				<div class="dropdown">
					<a href="${context}/viewuser" class="astyle" id="dropdownMenu1"
						aria-haspopup="true" aria-expanded="true">
						User </a>
				</div>
			</div>
			<div class="dropdown">
			<div class="col-sm-1" style="padding: 30px 4px 0 0;">
				<a href="#" class="dropdown-toggle astyle" id="dropdownMenu3"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
					Product</a>
				<ul class="dropdown-menu" aria-labelledby="dropdownMenu3">
						<li><a href="${context}/viewproduct">View All Product</a></li>
			...
			<div class="col-sm-1" style="padding: 30px 6px 0 0;">
				<a href="${context}/viewsupplier" class="astyle" id="dropdownMenu2"
					aria-haspopup="true" aria-expanded="true">
					Supplier</a>
				</div>
			</div>
